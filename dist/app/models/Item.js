...
class Item {
    constructor({ itemName, color, dateTime, description, brand, city, category, userId, isFounded, college, }) {
    ...
    static findItemsByUserIdorAll({ userId, limit, offset, founded, category, brand, color, college, latest, itemName, description, city, and = true, }) {
    ...
    static findItemBySearchStringRegExp({ limit, offset, searchString, userId, latest, }) {
